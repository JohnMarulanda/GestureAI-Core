...
def build_executable():
    ...
    try:
        ...
        files_to_clean = ['MouseController.spec']
        ...
        options = [
            'mouse_controller_enhanced.py',  # Script principal
            '--name=MouseControllerEnhanced',       # Nombre del ejecutable
            ...
            '--icon=assets/icons/mouse_controller.ico' if os.path.exists('assets/icons/mouse_controller.ico') else None,
            # Ocultar imports
            '--hidden-import=mediapipe',
            '--hidden-import=cv2',
            '--hidden-import=numpy',
            '--hidden-import=autopy',
        ...
        print("\nEl ejecutable se encuentra en: dist/MouseControllerEnhanced/MouseControllerEnhanced.exe")
        return True
