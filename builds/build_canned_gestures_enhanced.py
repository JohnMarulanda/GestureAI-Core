...
def build_executable():
    ...
    try:
        ...
        files_to_clean = ['CannedGesturesController.spec']
        ...
        options = [
            'canned_gestures_controller_enhanced.py',  # Script principal
            '--name=CannedGesturesControllerEnhanced',  # Nombre del ejecutable
            ...
            '--icon=assets/icons/canned_gestures_controller.ico' if os.path.exists('assets/icons/canned_gestures_controller.ico') else None,
            # Ocultar imports
        ...
        print("\nEl ejecutable se encuentra en: dist/CannedGesturesControllerEnhanced/CannedGesturesControllerEnhanced.exe")
        return True
