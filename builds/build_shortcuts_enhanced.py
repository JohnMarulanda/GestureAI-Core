...
def build_executable():
    ...
    try:
        ...
        files_to_clean = ['ShortcutsController.spec']
        ...
        options = [
            'shortcuts_controller_enhanced.py',  # Script principal
            '--name=ShortcutsControllerEnhanced',  # Nombre del ejecutable
            ...
            '--icon=assets/icons/shortcuts_controller.ico' if os.path.exists('assets/icons/shortcuts_controller.ico') else None,
            # Ocultar imports
        ...
        print("\nEl ejecutable se encuentra en: dist/ShortcutsControllerEnhanced/ShortcutsControllerEnhanced.exe")
        return True
