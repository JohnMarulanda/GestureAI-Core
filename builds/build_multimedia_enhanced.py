...
def copy_model_file():
    ...
    try:
        ...
        dist_models_dir = os.path.join('dist', 'MultimediaControllerEnhanced', 'models')
...
def build_executable():
    ...
    try:
        ...
        files_to_clean = ['MultimediaController.spec']
        ...
        options = [
            'core/controllers/multimedia_controller.py',  # Script principal
            '--name=MultimediaControllerEnhanced',       # Nombre del ejecutable
            ...
            '--icon=assets/icons/multimedia_controller.ico' if os.path.exists('assets/icons/multimedia_controller.ico') else None,
            # Ocultar imports
        ...
        print("\nEl ejecutable se encuentra en: dist/MultimediaControllerEnhanced/MultimediaControllerEnhanced.exe")
        return True
