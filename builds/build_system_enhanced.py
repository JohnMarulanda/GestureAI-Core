...
def copy_model_file():
    ...
    try:
        ...
        dist_models_dir = os.path.join('dist', 'SystemControllerEnhanced', 'models')
...
def build_executable():
    ...
    try:
        ...
        files_to_clean = ['SystemController.spec']
        ...
        options = [
            'system_controller_enhanced.py',  # Script principal
            '--name=SystemControllerEnhanced',       # Nombre del ejecutable
            ...
            '--icon=assets/icons/system_controller.ico' if os.path.exists('assets/icons/system_controller.ico') else None,
            # Ocultar imports
        ...
        print("\nEl ejecutable se encuentra en: dist/SystemControllerEnhanced/SystemControllerEnhanced.exe")
        return True
