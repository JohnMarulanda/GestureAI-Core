...
def build_executable():
    ...
    try:
        ...
        files_to_clean = ['BrightnessController.spec']
        ...
        options = [
            'brightness_controller_enhanced.py',  # Script principal
            '--name=BrightnessControllerEnhanced',  # Nombre del ejecutable
            ...
            '--icon=assets/icons/brightness_controller.ico' if os.path.exists('assets/icons/brightness_controller.ico') else None,
            # Ocultar imports
        ...
        print("\nEl ejecutable se encuentra en: dist/BrightnessControllerEnhanced/BrightnessControllerEnhanced.exe")
        return True
